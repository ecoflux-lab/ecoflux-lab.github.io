...
The <a href="https://github.com/ubc-micromet/Biomet.net" target="_blank" rel="noopener noreferrer">Biomet.net</a> repository contains libraries of computer code (in Matlab, R, and Python) related to running the data cleaning pipeline. It contains (a) the scripts to run the first, second, and third cleaning stages, as well as conversion to AmeriFlux format, and (b) many functions to help analyze and visualize data throughout all the stages of data processing and cleaning.
...
2. Click on the green "Code" button, and then click "Download ZIP":
    ...
    *Figure 2A. Screenshot of Biomet.net repository on GitHub, showing how to download.*
