...
This project directory must be on your local computer: do not put it on an external drive or cloud drive (like OneDrive or GDrive) as this will cause problems in the steps that follow.
