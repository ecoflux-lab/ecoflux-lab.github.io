...
<pre>
projectPath = '/Users/&lt;username&gt;/Projects/My_MicrometSites/';</pre>
...
2. In Matlab, run the `create_TAB_ProjectFolders` function (which is in the `Biomet.net` library that you cloned), as follows:
    ...
    Note that both input arguments have type "string".
...
<ol>
    ...
    <li>`biomet_sites_default.m`. 
</ol>

The latter two functions are used in the pipeline behind the scenes, and may also be useful to you later when you want to visualize your data.</li>
