...
- Recently updated <a href="presentations/DataCleaningPipeline_Overview_LabMeeting15Jan2026_FINAL.zip">Overview of Data Cleaning Pipeline</a> slides presented on 15 January 2026.
- Link to <a href="https://www.youtube.com/watch?v=wpeOC09LvS8&list=PLwwM5mY7NX4S62HBzrxXWvox_tWysd9un&ab_channel=EcoFluxLab" target="_blank" rel="noopener noreferrer">YouTube playlist of ALL presentations</a> from FLUXNET-CH4 V2.0 Workshop (October 2024), and accompanying slides for <a href="workshop/DataCleaningPipeline_Overview_Final_Web.zip">Overview of Data Cleaning Pipeline</a> presentation.
...
&emsp;2.7 &nbsp;Recommended Software Versions
...
&emsp;7.1 &nbsp;Recently Added Features
