...
- These are the "quick-start" instructions for new user of the data-cleaning pipeline. The full documentation will be made available at a later date. 
...
&emsp;5.0 &nbsp;Quick Start: EddyPro Processing\
