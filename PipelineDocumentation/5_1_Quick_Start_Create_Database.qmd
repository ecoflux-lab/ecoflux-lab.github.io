...
3. In your `Matlab` folder, create one new "main" Matlab file that will act as a "do-it-all" script. The example given here (figure 5.2) &mdash; named `MyMicrometSitesCleaning_Main.m` (you can make your filename less generic but we advise including "Main") &mdash; will create the database, and later we will add the code for data cleaning. This script can be copied from the <a href="#div_id_code">code block at the bottom of this page</a>. 
<!-- For instructions on how to convert other flux- and met-data formats, see section 5.2. -->

    <img src="images/matlab/Template_MyMicrometSites2c.jpg" alt="DirectoryTree:MatlabDirectory" width="600"/>
