...
3. *I am working on a Linux operating system and first stage cleaning is crashing.*

    Make sure that you are using upper case for the `measurementType` parameter, everywhere it appears in your first stage INI, e.g., `measurementType = 'Flux'` or `measurementType = 'Met'`.
