...
3. The files in the `Tutorial_filled_sample_files` folder are completed "filled-in" versions of the TEMPLATE files that work with the data downloaded in section 5.
