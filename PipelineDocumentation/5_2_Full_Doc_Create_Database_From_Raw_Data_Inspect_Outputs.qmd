...
Once your database is created, we strongly advise you to review its contents using `Biomet.net` functions. Some of these are listed in the tutorial under section 5.1, and section 6 provides extensive details of visualization tools for inspecting and analyzing raw and cleaned data.
